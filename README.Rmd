...
The **analysis** directory contains:
  ...
  - [:file\_folder: data-raw](/analysis/data-raw): Raw data used in the analysis.
  - [:file\_folder: data-derived](/analysis/data-derived): Data output of the analysis.
...
To re-create the analysis, clone this repository, change directories to it, and please run the following in *R*:
``` r
